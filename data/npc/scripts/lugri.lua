...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "task") then
		...
		elseif player:getStorageValue(Storage.KillingInTheNameOf.LugriNecromancers) == 1 then
			if player:getStorageValue(Storage.KillingInTheNameOf.LugriNecromancerCount) >= 1000 then
				npcHandler:say({
					"You've slain a mere {1000 necromancers and priestesses}. Still, you've shown some dedication. Maybe that means you can kill one of those so-called 'leaders' too. ...",
