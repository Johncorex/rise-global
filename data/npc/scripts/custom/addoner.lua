...
rift            = 22043
warmaster       = 22045
handoftheInquisitionoutfit  = 22038
wayfarer        = 22039
...
function HandOfTheInquisitionFirst(cid, message, keywords, parameters, node) 
    if(not npcHandler:isFocused(cid)) then 
        return false 
    end 

    if isPremium(cid) then 
    addon = getPlayerStorageValue(cid,handoftheInquisitionoutfit) 
    if addon == -1 then 
        ...
        if doPlayerRemoveItem(cid,36573,1) then 
            ...
            setPlayerStorageValue(cid,handoftheInquisitionoutfit,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function HandOfTheInquisitionSecond(cid, message, keywords, parameters, node) 
    ...
    if isPremium(cid) then 
    addon = getPlayerStorageValue(cid,handoftheInquisitionoutfit+1) 
    if addon == -1 then 
        ...
        if doPlayerRemoveItem(cid,36572,1) then 
            ...
            setPlayerStorageValue(cid,handoftheInquisitionoutfit+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
-- CITIZEN START -- 
function DonaterOutfit(cid, message, keywords, parameters, node) 
...
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "What you do is that you type 'first hunter addon' or 'second hunter addon' where you replace 'hunter' with whatever outfit you'd like to achieve the addons for. Assuming that you already collected all the required pieces, say 'yes' and vo�la - you got yourself an addon!"}) 
 ...
 node38 = keywordHandler:addKeyword({'second brotherhood addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second brotherhood addon you need to give me 1500 demonic essences. Do you have them with you?'}) 
    ...
    node40 = keywordHandler:addKeyword({'first hand of the inquisition addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Hand of the Inquisition addon you need to give me a final judgement. Do you have them with you?'}) 
    node40:addChildKeyword({'yes'}, HandOfTheInquisitionFirst, {}) 
    ...
    node41 = keywordHandler:addKeyword({'second hand of the inquisition addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Hand of the Inquisition addon you need to give me a shadow cowl. Do you have them with you?'}) 
    node41:addChildKeyword({'yes'}, HandOfTheInquisitionSecond, {}) 
    ...
    node39 = keywordHandler:addKeyword({'xxxxxxxxx123xx'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Wow! You are a Donator man! Congratulations, you can get a your mount exclusive?'}) 
    node39:addChildKeyword({'yes'}, DonaterOutfit, {}) 
    node39:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Alright then.', reset = true}) 

    node42 = keywordHandler:addKeyword({'first wayfarer addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first wayfarer addon you need to give me the Old Cape. Do you have them with you?'}) 
    node42:addChildKeyword({'yes'}, WayfarerFirst, {}) 
    ...
    node43 = keywordHandler:addKeyword({'second wayfarer addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second wayfarer addon you need to give me the Sedge Hat. Do you have them with you?'}) 
    node43:addChildKeyword({'yes'}, WayfarerSecond, {}) 
    ...
    node44 = keywordHandler:addKeyword({'first pumpkin addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first pumpkin addon you need to give me 20 Silver Raid Tokens. Do you have them with you?'}) 
    node44:addChildKeyword({'yes'}, PumpkinFirst, {}) 
    ...
    node45 = keywordHandler:addKeyword({'second pumpkin addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second pumpkin addon you need to give me 20 Silver Raid Tokens. Do you have them with you?'}) 
    node45:addChildKeyword({'yes'}, PumpkinSecond, {}) 
    ...
    node46 = keywordHandler:addKeyword({'first yalaharian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Yalaharian addon you need to give me 10 Silver Raid Tokens. Do you have them with you?'}) 
    node46:addChildKeyword({'yes'}, YalaharianFirst, {}) 
    ...
    node47 = keywordHandler:addKeyword({'second yalaharian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Yalaharian addon you need to give me 10 Silver Raid Tokens. Do you have them with you?'}) 
    node47:addChildKeyword({'yes'}, YalaharianSecond, {}) 
    ...
    node48 = keywordHandler:addKeyword({'first glooth addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Glooth addon you need to give me 10 Silver Raid Tokens. Do you have them with you?'}) 
    node48:addChildKeyword({'yes'}, GloothFirst, {}) 
    ...
    node49 = keywordHandler:addKeyword({'second glooth addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Glooth addon you need to give me 10 Silver Raid Tokens. Do you have them with you?'}) 
    node49:addChildKeyword({'yes'}, GloothSecond, {}) 
    ...
    node50 = keywordHandler:addKeyword({'first rift warrior addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Rift Warrior addon you need to give me 3 Gold Tokens. Do you have them with you?'}) 
    node50:addChildKeyword({'yes'}, riftFirst, {}) 
    ...
    node51 = keywordHandler:addKeyword({'second rift warrior addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Rift Warrior addon you need to give me 200 Silver Tokens. Do you have them with you?'}) 
    node51:addChildKeyword({'yes'}, riftSecond, {}) 
    ...
    -- elementalist 
    node52 = keywordHandler:addKeyword({'first elementalist addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Elementalist addon you need to give me 1 Elemental Spikes. Do you have them with you?'}) 
    node52:addChildKeyword({'yes'}, elementalistFirst, {}) 
    ...
    node53 = keywordHandler:addKeyword({'second elementalist addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Elementalist addon you need to give me 1 Mages Cap. Do you have them with you?'}) 
    node53:addChildKeyword({'yes'}, elementalistSecond, {}) 
...
-- elementalist end
-- warmaster
    node54 = keywordHandler:addKeyword({'first warmaster addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Warmaster addon you need to give me 1 Serpent Crest. Do you have them with you?'}) 
    node54:addChildKeyword({'yes'}, WarmasterFirst, {}) 
    ...
    node55 = keywordHandler:addKeyword({'second warmaster addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Warmaster addon you need to give me 1 Tribal Crest. Do you have them with you?'}) 
    node55:addChildKeyword({'yes'}, WarmasterSecond, {}) 
