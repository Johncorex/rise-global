...
local voices = {
	{ text = 'Seeing imbuement items, talk to me to buy at the best price!','Hell, bite me, there\'s a stone in my pocket, someone must have deceived me!' },
}
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "strike") then
		npcHandler:say("Do you want to buy items for critical imbuiment? This cost 1kk This cost 1kk", cid)
	...
	if msgcontains(msg, "vampirism") then
		npcHandler:say("Do you want to buy items for life leech imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "void") then
		npcHandler:say("Do you want to buy items for mana leech imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "bash") then
		npcHandler:say("Do you want to buy items for skill club imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "blockade") then
		npcHandler:say("Do you want to buy items for skill shield imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "chop") then
		npcHandler:say("Do you want to buy items for skill axe imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "epiphany") then
		npcHandler:say("Do you want to buy items for magic level imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "precision") then
		npcHandler:say("Do you want to buy items for skill distance imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "slash") then
		npcHandler:say("Do you want to buy items for skill sword imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "featherweight") then
		npcHandler:say("Do you want to buy items for capacity increase imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "swiftness") then
		npcHandler:say("Do you want to buy items for speed imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "vibrancy") then
		npcHandler:say("Do you want to buy items for paralysis removal imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "electrify") then
		npcHandler:say("Do you want to buy items for energy damage imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "frost") then
		npcHandler:say("Do you want to buy items for frost damage imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "reap") then
		npcHandler:say("Do you want to buy items for death damage imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "scorch") then
		npcHandler:say("Do you want to buy items for fire damage imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "venom") then
		npcHandler:say("Do you want to buy items for earth damage imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "cloud fabric") then
		npcHandler:say("Do you want to buy items for energy protection imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "demon presence") then
		npcHandler:say("Do you want to buy items for holy protection imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "dragon hide") then
		npcHandler:say("Do you want to buy items for fire protection imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "lich shroud") then
		npcHandler:say("Do you want to buy items for death protection imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "quara scale") then
		npcHandler:say("Do you want to buy items for ice protection imbuiment? This cost 1kk", cid)
	...
	if msgcontains(msg, "snake skin") then
		npcHandler:say("Do you want to buy items for earth protection imbuiment? This cost 1kk", cid)
...
keywordHandler:addKeyword({'packs'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to buy for Skill increase {Bash}, {Blockade}, {Chop}, {Epiphany}, {Precision}, {Slash}. Additional Attributes {Featherweight}, {Strike}, {Swiftness}, {Vampirism}, {Vibrancy}, {Void}. Elemental Damage {Electrify}, {Frost}, {Reap}, {Scorch}, {Venom}. Elemental Protection {Cloud Fabric}, {Demon Presence}, {Dragon Hide}, {Lich Shroud}, {Quara Scale}, {Snake Skin} ?'})


npcHandler:setMessage(MESSAGE_GREET, "Greetings brave |PLAYERNAME|, I sell imbuement items, just say {trade} or {packs} and I show you the list of items and their respective values.")
npcHandler:setMessage(MESSAGE_FAREWELL, "Good bye, |PLAYERNAME|. I hope I don't see you again with these commoner weapons here!")
