...
local grandcanondominus = GlobalEvent("grandcanondominus")
function grandcanondominus.onThink(interval, lastExecution)
...
-- grandcanondominus:interval(900000)
grandcanondominus:interval(500000)
grandcanondominus:register()