...
function playerLogin.onLogin(player)
	...
	if player:getLastLoginSaved() == 0 then
		...
		if player:getVocation():getClientId() == 1 then -- Knight
			local backpack = player:addItem(1988)
				if backpack then
					backpack:addItem(18559, 1) -- adventurer stone
					backpack:addItem(2554, 1) -- shovel
					backpack:addItem(2120, 1) -- rope
					backpack:addItem(2789, 10) -- brown mushroom
					backpack:addItem(2152, 50) -- platinum coin
					backpack:addItem(2439, 1) -- daramian mace
					backpack:addItem(8601, 1) -- steel axe
				end
					player:addItem(2481, 1, true, 1, CONST_SLOT_HEAD) -- soldier helmet
					player:addItem(2465, 1, true, 1, CONST_SLOT_ARMOR) -- brass armor
					player:addItem(2478, 1, true, 1, CONST_SLOT_LEGS) -- brass legs
					player:addItem(2643, 1, true, 1, CONST_SLOT_FEET) -- leather boots
					player:addItem(8602, 1, true, 1, CONST_SLOT_LEFT) -- jagged sword
					player:addItem(2509, 1, true, 1, CONST_SLOT_RIGHT) -- steel shield
					player:addItem(2050, 1, true, 1, CONST_SLOT_AMMO) -- torch
			elseif player:getVocation():getClientId() == 2 then -- Paladin
			local backpack = player:addItem(1988)
				if backpack then
					backpack:addItem(18559, 1) -- adventurer stone
					backpack:addItem(2554, 1) -- shovel
					...
					backpack:addItem(2789, 10) -- brown mushroom
					backpack:addItem(2152, 50) -- platinum coin
					backpack:addItem(2456, 1) -- bow
					backpack:addItem(2544, 100) -- arrow
					backpack:addItem(2509, 1) -- steel shield
				end
					player:addItem(2460, 1, true, 1, CONST_SLOT_HEAD) -- brass helmet
					player:addItem(2660, 1, true, 1, CONST_SLOT_ARMOR) -- ranger's cloak
					player:addItem(8923, 1, true, 1, CONST_SLOT_LEGS) -- ranger legs
					player:addItem(2643, 1, true, 1, CONST_SLOT_FEET) -- leather boots
					player:addItem(2389, 1, true, 1, CONST_SLOT_LEFT) -- spear
					player:addItem(40397, 1, true, 1, CONST_SLOT_RIGHT) -- quiver
					player:addItem(2050, 1, true, 1, CONST_SLOT_AMMO) -- torch
			elseif player:getVocation():getClientId() == 3 then -- Sorcerer
			local backpack = player:addItem(1988)
				if backpack then
					backpack:addItem(18559, 1) -- adventurer stone
					backpack:addItem(2554, 1) -- shovel
					...
					player:addItem(8820, 1, true, 1, CONST_SLOT_HEAD) -- mage hat
					player:addItem(8819, 1, true, 1, CONST_SLOT_ARMOR) -- magician's robe
					player:addItem(2468, 1, true, 1, CONST_SLOT_LEGS) -- studded legs
					player:addItem(2643, 1, true, 1, CONST_SLOT_FEET) -- leather boots
					player:addItem(2190, 1, true, 1, CONST_SLOT_LEFT) -- wand of vortex
					player:addItem(2175, 1, true, 1, CONST_SLOT_RIGHT) -- spellbook
					player:addItem(2050, 1, true, 1, CONST_SLOT_AMMO) -- torch
			elseif player:getVocation():getClientId() == 4 then -- Druid
			local backpack = player:addItem(1988)
				if backpack then
					backpack:addItem(18559, 1) -- adventurer stone
					backpack:addItem(2554, 1) -- shovel
					...
					player:addItem(2468, 1, true, 1, CONST_SLOT_LEGS) -- studded legs
					player:addItem(2643, 1, true, 1, CONST_SLOT_FEET) -- leather boots
					player:addItem(2182, 1, true, 1, CONST_SLOT_LEFT) -- snakebite rod
					player:addItem(2175, 1, true, 1, CONST_SLOT_RIGHT) -- spellbook
					player:addItem(2050, 1, true, 1, CONST_SLOT_AMMO) -- torch
			end
	else
